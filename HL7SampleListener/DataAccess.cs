...
namespace HL7SampleListener
{
    ...
    {
        public void InsertPatient(string firstName, string lastName, string emailAddress, string phoneNumber, string address)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(HelperDB.CnnVal("SampleDB")))
            {
                ...
                {
                    Console.WriteLine("Pred bazu stampa: " + person.Id + " " + person.FirstName + " " + person.LastName);
                }
